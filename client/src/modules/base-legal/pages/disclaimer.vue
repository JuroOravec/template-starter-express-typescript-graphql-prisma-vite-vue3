<template>
  <div class="Disclaimer">
    <h1 class="text-h4 py-8">DISCLAIMER</h1>
    <div class="text-body-1 font-weight-bold">
      Last updated
      <span>{{ format(dateLastUpdate, 'do MMM yyyy') }}</span>
    </div>

    <h3 class="text-h6">WEBSITE DISCLAIMER</h3>
    ...
    <!-- <div>
      ...
      <Linkable to="https://termly.io/products/disclaimer-generator/">
        Disclaimer Generator </Linkable
      >.
    </div> -->
  </div>
</template>
